...
export const CHANGELOG: Release[] = [
  {
    ...
    updates: [
      ...
      'Amp joins the CLIs you can put an agent on, alongside Claude Code, Codex, Gemini, Grok, OpenCode and Pi. It is Sourcegraph\'s coding agent, you need its amp binary installed for it to show as ready, and it has a free tier that does not ask for a card. There is no model to choose: Amp picks its own mix of open and frontier models for each request, so the model row says Default and stays out of your way',
    ],
  },
  {
    id: 36,
