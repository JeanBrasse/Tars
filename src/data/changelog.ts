...
export const CHANGELOG: Release[] = [
  {
    ...
    updates: [
      ...
      'Telegram starts an agent that is not running again, on /start_agent or a short message to the orchestrator: both launched nothing and left the agent marked running',
