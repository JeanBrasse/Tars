...
export const CHANGELOG: Release[] = [
  {
    ...
    updates: [
      ...
      'A terminal you come back to works the way you left it. Claude Code tells the terminal how it wants to be driven only once, when it starts: take the whole screen, receive the wheel, and have a paste marked where it begins and ends. Tars redraws a panel from the recent part of what the agent printed, and after a few minutes of a long turn that first message was no longer in it, so a panel you reopened by switching pages and back stopped handing the wheel to Claude Code, and a paste of several lines went out as separate lines, each one pressing Enter. Tars now keeps those settings when it trims what it keeps, so the wheel and pasting work the same in a panel you reopen and in the agent window',
    ],
  },
  {
    id: 39,
