...
/**
 * Vendor marks, drawn as their owners draw them.
 *
 * This is the one file in the app that paints something the design system does
 * not own: `DESIGN.md` keeps the provider marks as the exception ("Claude,
 * Codex, Gemini, Grok and the rest keep their own logos"), so they carry vendor
 * geometry and vendor colour, including the white glyph knocked out of the xAI
 * square below. That is raw appearance, and raw appearance is defined in
 * `src/components/ui/`. The colours of the provider name badges live at the
 * bottom of this file for the same reason.
 */
