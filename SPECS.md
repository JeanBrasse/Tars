...
- **A panel's history reaches back 1000 lines.** That is what a terminal's mirror keeps above the screen, where a panel that never unmounted keeps 10000. And a cursor parked past the last column (xterm waiting to wrap) comes back on the last column, since no cursor move reaches past it: 6 chunks in 3457 across nine recordings of Claude Code, the content identical.
